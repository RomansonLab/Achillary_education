...
async def main():
    ...
    # print(await client.contracts.get_functions(contract=Contracts.ARBITRUM_USDT))
    ...
    # print(await client.transactions.approved_amount())
    ...
    # res = await woofi.swap_wbtc_to_eth()
    if 'Failed' in res:
        logger.error(res)
    else:
        logger.success(res)
    ...
    # print(await tx.decode_input_data(client=client, contract=Contracts.ARBITRUM_WBTC))
